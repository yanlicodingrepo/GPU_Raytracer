...
/// @returns the quaternion from vector and radians
extern Vector4 getQuaternionFromAngle( const Vector4 &v, const REAL radians );

/// @returns the rotation matrix from quaternion
extern Matrix4x4 getRotMatFromQuaternion( const Vector4 &q );

/// @returns  the rotation matrix about the x axis by the specified angle, using quaternion
extern Matrix4x4 getRotXMatFromQuaternion( const REAL radians);
/// @returns  the rotation matrix about the y axis by the specified angle, using quaternion
extern Matrix4x4 getRotYMatFromQuaternion( const REAL radians);
/// @returns  the rotation matrix about the z axis by the specified angle, using quaternion
extern Matrix4x4 getRotZMatFromQuaternion( const REAL radians);
/// @returns  the rotation matrix about a vector by the specified angle, using quaternion
extern Matrix4x4 getRotMatFromQuaternion(const Vector4 &p, const Vector4 &v, const REAL a);
/// @returns  the inverse rotation matrix about the x axis by the specified angle, using quaternion
extern Matrix4x4 getInvRotXMatFromQuaternion( const REAL radians);
/// @returns  the inverse rotation matrix about the y axis by the specified angle, using quaternion
extern Matrix4x4 getInvRotYMatFromQuaternion( const REAL radians);
/// @returns  the inverse rotation matrix about the z axis by the specified angle, using quaternion
extern Matrix4x4 getInvRotZMatFromQuaternion( const REAL radians);
/// @returns  the inverse rotation matrix about a vector by the specified angle, using quaternion
extern Matrix4x4 getInvRotMatFromQuaternion(const Vector4 &p, const Vector4 &v, const REAL a);
//@}-----------------------------------------------------------------------------
