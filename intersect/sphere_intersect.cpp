                            ...
                            )
{
    ...
    REAL B = 2*eyePos.x*d.x + 2*eyePos.y*d.y+ 2*eyePos.z*d.z;
    REAL C = eyePos.x*eyePos.x + eyePos.y*eyePos.y + eyePos.z*eyePos.z - 0.25;
...
{
    Vector3 norm = Vector3( intersectPoint.x/intersectPoint.w, intersectPoint.y/intersectPoint.w, intersectPoint.z/intersectPoint.w );
                                            ...
                                            )
{
    ...
    resultColor = bilinearInterpTexel( object.m_texture.m_texPointer, x, y, width, height );
    resultColor.a = 0;
    return resultColor;
}
